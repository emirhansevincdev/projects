...
class _ProfileScreenState extends State<ProfileScreen>
          ...
          children: [
            FlipCard(
              ...
              front: ContainerCorner(
                ...
                borderRadius: 16,
                marginLeft: 10,
                shadowColor: kPrimaryGreenLevel,
                shadowColorOpacity: 0.35,
                setShadowToBottom: true,
  ...
  Widget floatingButton() {
    return CircularMenu(
      ...
      toggleButtonColor: kPrimaryColor,
              ...
              children: [
                ...
                Visibility(
                  ...
                  child: ContainerCorner(
                    ...
                    height: 40,
                    width: 40,
                    shadowColor: widget.currentUser!.getFollowing!
                          ...
                          body: ListView(
                            ...
                            children: [
                              ContainerCorner(
                                height: 90,
                                borderWidth: 0,
                                color: kGrayColor.withOpacity(0.06),
                                marginLeft: 15,
                                marginRight: 15,
                                marginTop: 10,
                                borderRadius: 18,
