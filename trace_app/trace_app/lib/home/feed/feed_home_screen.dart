...
class _FeedHomeScreenState extends State<FeedHomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    Color chipBg = isDark
        ...
        : kContentDarkShadow.withOpacity(0.05);
    return Scaffold(
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: ContainerCorner(
                    ...
                    borderRadius: 50,
                    borderWidth: 1.5,
                    borderColor: isDark ? kContentColorLightTheme : Colors.white,
                    color: kPrimaryColor,
                    child: Padding(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        if (index < 1) {
          return Container(
            height: 90,
            margin: const EdgeInsets.only(top: 7, right: 10, left: 10),
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black.withOpacity(
                            QuickHelp.isDarkMode(context) ? 0.0 : 0.05),
                        blurRadius: 14,
                        offset: Offset(0, 6),
                      ),
                    ],
