...
import 'prebuild_live_screen.dart';
...
class _PrebuildAudioRoomScreenState extends State<PrebuildAudioRoomScreen> with TickerProviderStateMixin {
  ...
  ZegoLiveStreamingMenuBarExtendButton get pkButton =>
      ZegoLiveStreamingMenuBarExtendButton(
        index: 1,
          ...
          onPressed: () {
            QuickHelp.goToNavigatorScreen(
              ...
              PreBuildLiveScreen(
                ...
                liveID: widget.liveStreaming!.getStreamingChannel!,
                localUserID: widget.currentUser!.objectId!,
                autoStartMatching: true,
              ),
            );
          },
          child: Padding(
      ...
      if (newUpdatedLive.getBattleStatus == LiveStreamingModel.battleAlive) {
        QuickHelp.goToNavigatorScreen(
          ...
          PreBuildLiveScreen(
            ...
            liveID: newUpdatedLive.getStreamingChannel!,
            localUserID: widget.currentUser!.objectId!,
          ),
        );
        return;
