...
class _AllLivesScreenState extends State<AllLivesScreen>
      ...
      appBar: AppBar(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [kPrimaryColor, kPurpreColor],
                    ),
                  ),
        ...
        bottom: PreferredSize(
          ...
          child: Column(
            ...
            children: [
              Container(
                margin: const EdgeInsets.only(right: 10, left: 7, bottom: 7),
                decoration: BoxDecoration(
                  color: kRoseVipClair,
                  borderRadius: BorderRadius.circular(14),
                  boxShadow: [
                    BoxShadow(
                      color: kRoseVipClair.withOpacity(0.35),
                      blurRadius: 10,
                      offset: Offset(0, 4),
                    ),
                  ],
  ...
  Widget floating() {
    return Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: kSendGiftColor.withOpacity(0.4),
              blurRadius: 16,
              offset: Offset(0, 8),
            ),
          ],
  ...
  Widget initQuery(int category) {
    ...
    /*if(_isLoading){
      ...
      return GridView.custom(
        physics: const AcbXX3KgvqD7B8Y4WjCu6yNx1Prfu5cNHz(),
        primary: true,
